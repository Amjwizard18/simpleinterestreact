...
function App() {
  ...
  const validate =(e)=>{
    ...
    // regular expression- used to check pattern of a given string 
    // ----------
    // 1) start with  ^
    // 2) ends with   $
    // 3) n pattern inside the bracket
    // ^[0-9a-zA-Z@]*{MIN,MAX}$/
    // - match() - Check whether the reg express matches with the given string -retrun array if the expression matches with string else returns null
